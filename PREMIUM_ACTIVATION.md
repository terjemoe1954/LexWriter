...
- Current test baseline: 60 unit tests pass and build-for-testing succeeds. UI tests compile but cannot run until the `LexWriterUITests` target application path is fixed in Xcode.
