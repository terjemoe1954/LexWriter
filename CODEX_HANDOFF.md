...
- App build: succeeded.
- Latest separate validation run on 2026-09-22 after support print/PDF troubleshooting wording: unit tests 84/84 passed, build-for-testing succeeded, app build succeeded, UI tests 7/7 passed, and launch test 1/1 passed.
