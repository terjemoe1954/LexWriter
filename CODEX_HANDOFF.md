...
1. Continue with manual 1.1 checks: App Store Connect or Xcode Organizer crash/review checks, broader device smoke testing, print/PDF review, and screenshot/metadata review.
