...
- App build: succeeded.
- Latest separate validation run on 2026-09-22: unit tests 83/83 passed, build-for-testing succeeded, app build succeeded, UI tests 7/7 passed, and launch test 1/1 passed.
