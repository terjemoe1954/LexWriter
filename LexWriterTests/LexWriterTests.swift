...
struct LexWriterTests {
    ...
    @Test func versionOneOnePlanKeepsPremiumActivationDeferred() async throws {
        ...
        #expect(plan.contains("device smoke testing, print/pdf review, and screenshot/metadata review"))
    ...
    @Test func codexHandoffKeepsSafeSessionInstructionsCurrent() async throws {
        ...
        #expect(handoff.contains("broader device smoke testing, print/pdf review, and screenshot/metadata review"))
