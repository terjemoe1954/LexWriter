...
- Unit tests currently cover the premium-preview state, supported languages, document card titles/subtitles/icons, access-tier/monetization-plan consistency, printable HTML-preview/signature structure, home-screen legal-scope copy, Settings privacy copy, User Guide localization, and User Guide access/privacy/legal-scope copy.
