...
- Reverified the separate validation gates after printable HTML signature page-break protection: unit tests 83/83, build-for-testing, app build, UI tests 7/7, and launch test 1/1.
