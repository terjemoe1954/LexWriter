...
- Reverified the separate validation gates after App Store release-note print/PDF wording: unit tests 84/84, build-for-testing, app build, UI tests 7/7, and launch test 1/1.
